                ...
                <div class="table-responsive">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-hover">
                            ...
                            <tr>
                                <td class="text-uppercase text-dark text-center text-xs font-weight-bolder">{{ $index + 1 }}</td>
                                <td class="text-uppercase text-dark text-center text-xs font-weight-bolder">{{ $item->kode_proyek }}</td>
                                <td class="text-uppercase text-dark text-center text-xs font-weight-bolder">{{ $item->nama_proyek }}</td>
                                <td class="text-uppercase text-dark text-center text-xs font-weight-bolder">{{ $item->penanggung_jawab }}</td>
                                <td class="text-uppercase text-dark text-center text-xs font-weight-bolder">{{ $item->bidang }}</td>
                                <td class="text-uppercase text-dark text-center text-xs font-weight-bolder">{{ $item->tanggal->format('d-m-Y') }}</td>
                                ...
                                <td class="text-uppercase text-dark text-center text-xs font-weight-bolder">{{ $item->status }}</td>
                            </tr>
                            @endforeach
                        </table>
