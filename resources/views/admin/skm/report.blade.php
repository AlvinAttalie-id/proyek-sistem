                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-hover">
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-center text-xxs font-weight-bolder opacity-7">Penilaian Pegawai</th>
                                <th class="text-uppercase text-secondary text-center text-xxs font-weight-bolder opacity-7">Penilaian Kegiatan</th>
                                <th class="text-uppercase text-secondary text-center text-xxs font-weight-bolder opacity-7">Penilaian Program</th>
                                <th class="text-uppercase text-secondary text-center text-xxs font-weight-bolder opacity-7">Total Penilaian</th>
                            ...
                            <tr>
                                ...
                                <td class="text-uppercase text-secondary text-center text-xxs font-weight-bolder opacity-7">{{ $data->keterangan}}</td>
                            @endforeach
                        </table>
