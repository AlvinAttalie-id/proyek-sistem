                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-hover">
                            ...
                            <tr>
                                ...
                                <td class="text-uppercase text-secondary text-center text-xxs font-weight-bolder opacity-7">{{ $item->nama_supplier }}</td>
                                <td class="text-uppercase text-secondary text-center text-xxs font-weight-bolder opacity-7">{{ $item->jumlah_masuk }}</td>
