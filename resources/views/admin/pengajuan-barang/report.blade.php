                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-hover">
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-center text-xxs font-weight-bolder opacity-7">Penanggung Jawab</th>
                                <th class="text-uppercase text-secondary text-center text-xxs font-weight-bolder opacity-7">Jumlah Keluar</th>
