            ...
            <div class="card-body pt-4 p-3">
                <form action="/user-profile" method="POST" role="form text-left">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="user-bidang" class="form-control-label">{{ __('Bidang') }}</label>
                                <div class="@error('bidang') border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="text" placeholder="Bidang" id="user-bidang" name="bidang" value="{{ old('bidang') }}">
                                    @error('bidang')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="tanggal-awal" class="form-control-label">{{ __('Tanggal Awal') }}</label>
                                <div class="@error('tanggal_awal') border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="date" id="tanggal-awal" name="tanggal_awal" value="{{ old('tanggal_awal') }}">
                                    @error('tanggal_awal')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="tanggal-akhir" class="form-control-label">{{ __('Tanggal Akhir') }}</label>
                                <div class="@error('tanggal_akhir') border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="date" id="tanggal-akhir" name="tanggal_akhir" value="{{ old('tanggal_akhir') }}">
                                    @error('tanggal_akhir')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
